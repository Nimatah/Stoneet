    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_type', models.CharField(choices=[('bool', 'Boolean'), ('str', 'String'), ('int', 'Integer'), ('float', 'Float'), ('image', 'Image'), ('dropdown', 'Dropdown'), ('range', 'Range'), ('multiple', 'Multiple Choice')], max_length=255)),
                ('options', models.TextField(blank=True, null=True)),
                ('unit', models.CharField(blank=True, max_length=255)),
                ('range_type', models.CharField(blank=True, choices=[('from', 'کمترین'), ('to', 'بیشترین')], max_length=255, null=True)),
