...
admin_patterns = [
    ...
    path('panel/admin-list-request/', admin.ProfileRequestListView.as_view(), name='admin_list_request'),
    ...
    path('panel/admin-edit-admin/<int:pk>', admin.EditAdminView.as_view(), name='admin_edit_admin'),
    path('panel/admin-edit-seller/<int:pk>', admin.EditSellerView.as_view(), name='admin_edit_seller'),
    path('panel/admin-edit-buyer/<int:pk>', admin.EditBuyerView.as_view(), name='admin_edit_buyer'),
    path('panel/admin-edit-logistic/<int:pk>', admin.EditLogisticView.as_view(), name='admin_edit_logistic'),
]
