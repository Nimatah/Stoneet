...
admin_patterns = [
    ...
    path('panel/admin-qc-seller-list/', admin.QCSellerListView.as_view(), name='admin_qc_seller'),
    path('panel/admin-qc-logistic-details/<int:pk>/', admin.QCLogisticDetailView.as_view(), name='admin_qc_logistic_details'),
    path('panel/admin-qc-logistic-list/', admin.QCLogisticListView.as_view(), name='admin_qc_logistic'),
