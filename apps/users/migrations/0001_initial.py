# Generated by Django 3.1.2 on 2020-11-05 12:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('seller', 'Seller'), ('logistic', 'Logistic'), ('buyer', 'Buyer')], default='buyer', max_length=20)),
                ('legal_type', models.CharField(choices=[('individual', 'Individual'), ('legal', 'Legal')], default='individual', max_length=20)),
                ('state', models.CharField(choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('rejected', 'Rejected')], max_length=20)),
