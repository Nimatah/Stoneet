...
class AddProductView(UserPassesTestMixin, FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['attributes_field'] = Attribute.objects.get_by_input_field()
        context['attributes_image'] = Attribute.objects.get_by_image_field()
        context['attributes_bool'] = Attribute.objects.get_by_bool_field()
        return context
